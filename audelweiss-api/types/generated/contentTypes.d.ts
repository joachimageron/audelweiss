...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    centralRichtext: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    leftColumnLinks: Schema.Attribute.Component<'component.simple-link', true>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    reseaux: Schema.Attribute.Component<'component.reseaux', true>;
    rightColumnLinks: Schema.Attribute.Component<'component.simple-link', true>;
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    item: Schema.Attribute.DynamicZone<
      ['order.item-product-reference', 'order.item-discount-reference']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiProductVariantOptionProductVariantOption
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-variant-option.product-variant-option'
    > &
      Schema.Attribute.Private;
...
export interface ApiProductVariantProductVariant
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    format: Schema.Attribute.Enumeration<['radio', 'checkbox', 'input']> &
      Schema.Attribute.Required;
    helper_text: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-variant.product-variant'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variant_options: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-variant-option.product-variant-option'
    >;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    productSlug: Schema.Attribute.UID<'name'>;
    publishedAt: Schema.Attribute.DateTime;
